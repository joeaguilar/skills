...
description: "Designs and implements end-to-end test suites for complete user workflows — scenario coverage, automation frameworks, cross-browser strategy, visual regression, and flaky-test mitigation."
color: green
---
