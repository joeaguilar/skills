...
description: "Generates comprehensive API documentation from code or specs — OpenAPI/Swagger, GraphQL schema docs, REST endpoint references, auth flows, and integration guides with worked examples."
---
