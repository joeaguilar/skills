...
description: "Analyzes cloud infrastructure spend (AWS/Azure/GCP/multi-cloud) and identifies cost optimizations — right-sizing, reservations, architecture changes — without sacrificing performance."
---
