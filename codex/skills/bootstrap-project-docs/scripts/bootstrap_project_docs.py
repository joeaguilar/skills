...
def docs(project_name: str) -> dict[str, str]:
    return {
        ...
        "SOUL.md": clean(
            ...
            Codex is the engineering agent for this repository. The agent should preserve context, make pragmatic implementation choices, and keep the project documentation accurate as decisions are made.
