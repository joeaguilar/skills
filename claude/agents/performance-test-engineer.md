...
description: "Creates performance and load tests, analyzes bottlenecks, and validates systems under expected traffic — stress scenarios, metrics analysis, and optimization recommendations."
color: orange
---
